...
<html lang="en">
    ...
    <body>
        <div class="header">
            ...
            <a href="../HTML/signUp.html?flag=1"  id="sign-up-link">Sign Up</a>
            <a href="../HTML/signUp.html?flag=0"  id="log-in-link">Log In</a>
        </div>
        <div class="ParaVideo">
        ...
        <div class="ParaContent">
            <div id="graphic-container">
                <img src="../media/UFOgraphic.png" id="graphic-1">
            </div>
